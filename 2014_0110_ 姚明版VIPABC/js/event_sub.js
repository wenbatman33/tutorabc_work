$(function() {
	...
	//固定 landing from
	$('.landing').css('top','400px');
	var position = $('.landing').position();
	var sticky_navigation_offset_top =  position.top;
	var upLine=sticky_navigation_offset_top- $('.newHearder').height();
	var speed=500;
    ...
    if (scroll_top > bottomLine) {
        ...
        $('.landingForm').stop().animate({'top':scroll_top-270},speed );
        $('.CustomerServiceIcon').stop().animate({'top':scroll_top-270},speed );
    }else{
