					...
					<!--Video START-->
						<div class="guide-vdotutorials clearfix">
						  <div class="vdo-fction-area">
							<div class="fction-bar-on"><a href="guide_EnvirVideo1.asp">如何订位</a></div>
							...
							<div class="fction-bar"><a href="guide_EnvirVideo4.asp">课后评鉴及课后作业</a></div>
							<div class="fction-bar"><a href="guide_EnvirVideo5.asp">其他重要须知</a></div>
						  </div>
						  <div class="vdo-player-area">
						  <iframe src="guide_EnvirVideo1_.asp" width="545" height="410" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" ></iframe>
						 <!--<embed id="ShowVideo" src="/video/envTest/step1.wmv" width="400" height="300" AllowChangeDisplaySize="false" type="application/x-mplayer2" wmode="transparent" showstatusbar="0" autostart="true" EnableContextMenu="false" ></embed>-->
