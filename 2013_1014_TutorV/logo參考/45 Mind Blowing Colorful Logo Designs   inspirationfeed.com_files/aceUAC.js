...
window.adcom = window.adcom || {};

window.adcom.webStorageTest = false;

window.adcom.webStorageTestWhiteList = {
 "100": true
};

window.adcom.webStorageTestUrl = "http://www.advertising.com:8080/webStorageTest.html";
...
alternateRegionHosts[REGIONS.DEFAULT] = "http://r1.ace";
...
ACE3NewHost['884878']=100
ACE3NewHost['881430']=100
ACE3NewHost['880643']=100
ACE3NewHost['874054']=100
ACE3NewHost['868647']=100
ACE3NewHost['874273']=100
ACE3NewHost['864203']=100
ACE3NewHost['864220']=100
ACE3NewHost['879397']=100
ACE3NewHost['859132']=100
ACE3NewHost['877699']=100
ACE3NewHost['869178']=100
ACE3NewHost['850873']=100
ACE3NewHost['850684']=100
ACE3NewHost['873142']=100
ACE3NewHost['845244']=100
ACE3NewHost['872849']=100
ACE3NewHost['863289']=100
ACE3NewHost['857741']=100
ACE3NewHost['834651']=100
ACE3NewHost['845611']=100
ACE3NewHost['834793']=100
ACE3NewHost['826172']=100
ACE3NewHost['861225']=100
ACE3NewHost['823214']=100
ACE3NewHost['819012']=100
ACE3NewHost['820836']=100
ACE3NewHost['868606']=100
ACE3NewHost['874604']=100
ACE3NewHost['842818']=100
ACE3NewHost['810811']=100
ACE3NewHost['800700']=100
ACE3NewHost['784874']=100
ACE3NewHost['838993']=100
ACE3NewHost['878462']=100
ACE3NewHost['803972']=100
ACE3NewHost['782102']=100
ACE3NewHost['832426']=100
...
function ACE3_AdRequest(obj) {
 ...
 ACE_AR = "";
 try {
  var addWebStorageTestToPage = function() {
   if (window.adcom.webStorageTestFired) {
    return;
   }
   window.adcom.webStorageTestFired = true;
   document.write('<iframe width="0" height="0" style="display:none;" src="' + window.adcom.webStorageTestUrl + '"></iframe>');
  };
  var hasWebStorageSupport = function() {
   try {
    var mod = "";
  ...
  if (window.adcom.webStorageTest && window.adcom.webStorageTestWhiteList[obj["site"].toString()] && obj["exchmap"] != "0" && iOS && hasWebStorageSupport()) {
   addWebStorageTestToPage();
  }
 } catch (e) {}
}

function ACErtbCheck(site, regObj) {
 if (document.location.protocol == "https:" && !document.getElementById("ACE3RTBPingFile") && Math.floor(Math.random() * 100) + 1 <= ACE3RTBglobalThrottle) {
  var host = "https://secure.leadback.advertising.com/";
  if (regObj == 2) {
   rcode = "&rCode=2";
  } else if (regObj == 3) {
   rcode = "&rCode=3";
  ...
  var url = host + "cfcm.ashx?providerid=1011" + rcode + "&site=" + site;
 ...
 if (document.location.protocol != "https:" && !document.getElementById("ACE3RTBPingFile") && Math.floor(Math.random() * 100) + 1 <= ACE3RTBglobalThrottle) {
  ...
  rtbPing.id = "ACE3RTBPingFile";
  rtbPing.name = "ACE3RTBPingFile";
  rtbPing.src = "http://cmap.uac.ace.advertising.com/um.ashx?site=" + site + rcode;
  rtbPing.width = 0;
  rtbPing.height = 0;
  rtbPing.style.width = "0px";
  rtbPing.style.height = "0px";
...
function ComScorePixelCheck(site) {
