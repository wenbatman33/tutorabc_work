...
If UCase(signMsg)=UCase(merchantSignMsg) then
	...
	Select Case payResult
		  ...
		  case "10"
			...
			rtnOk=1
			rtnUrl = "http://" & CONST_VIPABC_WEBHOST_NAME & "/program/member/payment_return_page_for_99bill.asp?stat=succ"
			
		  
		 Case else

			rtnOk=1
			rtnUrl = "http://" & CONST_VIPABC_WEBHOST_NAME & "/program/member/payment_return_page_for_99bill.asp?stat=fail"
	...
	rtnOk = 1
	rtnUrl = "http://" & CONST_VIPABC_WEBHOST_NAME & "/program/member/payment_return_page_for_99bill.asp?stat=err"
