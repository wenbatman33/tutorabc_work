...
'if ( true = Session("test_staff") OR true = bolComboProduct ) then
...
if ( true = Session("test_staff") OR true = bolComboProduct ) then
'if ( true = bolComboProduct ) then
    bolShort20Session = false
else
    bolShort20Session = true
end if
...
<div class="main_membox">
    <div class='page_title_1'><h2 class='page_title_h2'>预订/取消课程 </h2></div>
    ...
    <div class="choose">
        ...
        <% 
            ...
            dim strShortLobby20BtnUrl : strShortLobby20BtnUrl = "" 'Lobby按鈕連結
            dim strShortLobby20BtnHtml : strShortLobby20BtnHtml = "" 'Lobby按鈕Html
            ...
            strShortLobby20BtnUrl = "<a href='/program/aspx/AspxLogin.asp?url_id=7' target='_blank' title='预订20mins大会堂课程' alt='预订20mins大会堂课程'></a>"
            ...
            if ( true = bolShort20Session ) then
            else
                strShortLobby20BtnUrl = ""
            end if
            ...
            if ( Not isEmptyOrNull(strShortLobby20BtnUrl) ) then
                strShortLobby20BtnHtml = "<div class='btn4'>" & strShortLobby20BtnUrl & "</div>"
            else
                strShortLobby20BtnHtml = ""
            end if
        %>
