...
if (Not isEmptyOrNull(str_search_time)) then
    ...
    str_attend_condition_time = " AND (member.ClassRecord.ClassStartTime = '"&str_search_time&"')  "
end if
...
if ( true = bolDebugMode ) then
    ...
    response.write "str_attend_condition_datetime : " & str_attend_condition_datetime & "<br/>"
    response.write "str_attend_condition_time : " & str_attend_condition_time & "<br/>"
                    ...
                    <h2>
                        <div class="l_r r_02" style="padding-left: 35px;">
                            ...
                            <div class="consultant_name" >
                                ...
                                if  ( 1 = sCInt(intSessionStatus) ) then 
