...
<%
    ...
    '*****************************************************************************************/
        ...
        str_sql = "SELECT CONVERT(varchar, client_attend_list.attend_date, 111) AS sdate, " &_
                  ...
                  "ISNULL(lobby_session.SessionStartMinute,30) AS SessionStartMinute, " &_
                  "ISNULL(lobby_session.SessionPeriod,45) AS SessionPeriod " &_
        ...
        dim intSTime : intSTime = 30
        dim intPeriod : intPeriod = 45
        ...
        if (isSelectQuerySuccess(arr_attend_list_data)) then
            if (Ubound(arr_attend_list_data) >= 0) then
                for i = 0 to Ubound(arr_attend_list_data, 2)
                    intSTime = right("00" & arr_attend_list_data(9, i),2)
                    intPeriod = arr_attend_list_data(10, i)
                    if ( 10 = sCInt(intPeriod) ) then
                        bolCancel = false
                    else
                        bolCancel = true
                    end if
                    ...
                    str_cancel_class_datetime = arr_attend_list_data(0, i) & " " & Right("0"&arr_attend_list_data(1, i), 2) & ":" & intSTime
                    str_title = arr_attend_list_data(0, i) & chr(10)
                    'str_title = str_title & arr_attend_list_data(1, i) & ":30" & chr(10)
                    str_title = str_title & arr_attend_list_data(1, i) & ":" & intSTime & chr(10)

                    '大會堂 ball_blue
                    'if (arr_attend_list_data(4, i) > 12) then
		            '20120905 阿捨新增 大會堂改用special_sn判斷
		             if ( Not isEmptyOrNull(arr_attend_list_data(8, i) )  ) then 
                        ...
                        str_title = str_title & intPeriod & "mins-" & str_msg_sel_lobby_option
                    '一對三 ball_red
                    ...
                    '一對一 ball_green
                    elseif ( sCInt(arr_attend_list_data(3, i)) = CONST_CLASS_TYPE_ONE_ON_ONE) then
                    ...
                    if (p_int_type = 1) then
                        if (DateDiff("n", now(), str_cancel_class_datetime) >= 240 and bol_client_have_valid_contract) then
                            ...
                            arr_prev_td(Day(arr_attend_list_data(0, i))) = arr_prev_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":" & intSTime&"</span>"
                            if ( true = bolCancel ) then
                                arr_prev_td(Day(arr_attend_list_data(0, i))) = arr_prev_td(Day(arr_attend_list_data(0, i))) & "<a id=""cancel_class_link_"&arr_attend_list_data(7, i)&""" href=""javascript:void(0);"" onclick=""javascript:g_obj_reservation_class_ctrl.cancelClass('"&arr_attend_list_data(7, i)&"', '"&arr_attend_list_data(0, i)&"', '"&arr_attend_list_data(1, i)&"');"">"&str_msg_a_cancel_class&"</a><img id=""img_cancel_class_loading_"&arr_attend_list_data(7, i)&"""  width=""25"" height=""25"" src=""/lib/javascript/JQuery/images/ajax-loader.gif"" border=""0"" style=""display:none;""/></p>"
                            end if
                        '四小時內無法取消 不顯示取消的按鈕 或 合約已到期
                            ...
                            arr_prev_td(Day(arr_attend_list_data(0, i))) = arr_prev_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":" & intSTime&"</span></p>"
                        end if
                    'Now
                    elseif (p_int_type = 2) then
                        if (DateDiff("n", now(), str_cancel_class_datetime) >= 240 and bol_client_have_valid_contract) then
                           ' arr_now_td(Day(arr_attend_list_data(0, i))) = arr_now_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":30</span><a id=""cancel_class_link_"&arr_attend_list_data(7, i)&""" href=""javascript:void(0);"" onclick=""javascript:g_obj_reservation_class_ctrl.cancelClass('"&arr_attend_list_data(7, i)&"', '"&arr_attend_list_data(0, i)&"', '"&arr_attend_list_data(1, i)&"');"">"&str_msg_a_cancel_class&"</a><img id=""img_cancel_class_loading_"&arr_attend_list_data(7, i)&"""  width=""25"" height=""25"" src=""/lib/javascript/JQuery/images/ajax-loader.gif"" border=""0"" style=""display:none;""/></p>"
                            arr_now_td(Day(arr_attend_list_data(0, i))) = arr_now_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":" & intSTime&"</span>"
                            if ( true = bolCancel ) then
                                arr_now_td(Day(arr_attend_list_data(0, i))) = arr_now_td(Day(arr_attend_list_data(0, i))) & "<a id=""cancel_class_link_"&arr_attend_list_data(7, i)&""" href=""javascript:void(0);"" onclick=""javascript:g_obj_reservation_class_ctrl.cancelClass('"&arr_attend_list_data(7, i)&"', '"&arr_attend_list_data(0, i)&"', '"&arr_attend_list_data(1, i)&"');"">"&str_msg_a_cancel_class&"</a><img id=""img_cancel_class_loading_"&arr_attend_list_data(7, i)&"""  width=""25"" height=""25"" src=""/lib/javascript/JQuery/images/ajax-loader.gif"" border=""0"" style=""display:none;""/></p>"
                            end if
                        '四小時內無法取消 不顯示取消的按鈕 或 合約已到期
                        else
                            ...
                            arr_now_td(Day(arr_attend_list_data(0, i))) = arr_now_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":" & intSTime&"</span></p>"
                        end if
                    'Next
                    else
                        if (DateDiff("n", now(), str_cancel_class_datetime) >= 240 and bol_client_have_valid_contract) then
                            ...
                            arr_next_td(Day(arr_attend_list_data(0, i))) = arr_next_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":" & intSTime&"</span>"
                            if ( true = bolCancel ) then
                                arr_next_td(Day(arr_attend_list_data(0, i))) = arr_next_td(Day(arr_attend_list_data(0, i))) & "<a id=""cancel_class_link_"&arr_attend_list_data(7, i)&""" href=""javascript:void(0);"" onclick=""javascript:g_obj_reservation_class_ctrl.cancelClass('"&arr_attend_list_data(7, i)&"', '"&arr_attend_list_data(0, i)&"', '"&arr_attend_list_data(1, i)&"');"">"&str_msg_a_cancel_class&"</a><img id=""img_cancel_class_loading_"&arr_attend_list_data(7, i)&"""  width=""25"" height=""25"" src=""/lib/javascript/JQuery/images/ajax-loader.gif"" border=""0"" style=""display:none;""/></p>"
                            end if
                        '四小時內無法取消 不顯示取消的按鈕 或 合約已到期
                        else
                            ...
                            arr_next_td(Day(arr_attend_list_data(0, i))) = arr_next_td(Day(arr_attend_list_data(0, i))) & "<p id=""cancel_class_info_"&arr_attend_list_data(7, i)&"""><span "&str_ball_style_class&" title=""" & str_title & """>●</span><span class=""color_1"" title=""" & str_title & """>" & arr_attend_list_data(1, i) & ":" & intSTime&"</span></p>"
                        end if
                    end if
                next
            end if
        ...
        <%
            ...
            if (int_dat_month_of_week_first > 1) then
                ...
                if (Not isCalenderYearMonthBiggerThanNow(int_prev_year, int_prev_month)) then
                    ...
                    '只撈上個月指定日期有訂的課程
                    if (str_attend_date_condition <> "") then
                        str_attend_date_condition = " AND (client_attend_list.attend_date IN (" & str_attend_date_condition & ")) "
                    end if
            ...
            str_attend_date_condition = " AND (client_attend_list.attend_date BETWEEN '" & int_dat_year & "/" & Right("0" & int_dat_month, 2) & "/01' AND '" & int_dat_year & "/" & Right("0" & int_dat_month, 2) & "/" & int_arr_month_day(int_dat_month) & "') "
