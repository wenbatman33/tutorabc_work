    var g_obj_class_calender = {
        ...
        arr_page_url : {
            ...
            "ajax_class_list_calender" : "/program/member/reservation_class/include/ajax_class_list_calender_JR.asp",              // ajax 觀看課表 月曆模式 顯示日期
            ...
            "ajax_class_list_week": "/program/member/reservation_class/include/ajax_class_list_week_JR.asp",                      // ajax 觀看課表 列表模式 顯示日期
            "ajax_cancel_class" : "/program/member/reservation_class/include/ajax_cancel_class_JR.asp"                             // ajax 取消課程
        },
