...
<div class="temp_contant">
    <div class="main_membox">
	    <iframe name="I1" style="text-align: center" src="check_joinnet_room.asp?language=<%=request("language")%>&rand=<%=NewGUID%>" width="100%" height="250" marginwidth="1" marginheight="1" scrolling="no" border="0" align="center" frameborder="0" ></iframe>
    </div>
