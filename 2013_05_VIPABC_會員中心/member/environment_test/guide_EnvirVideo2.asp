					...
					<!--Video START-->
						<div class="guide-vdotutorials clearfix">
						  <div class="vdo-fction-area">
							...
							<div class="fction-bar-on"><a href="guide_EnvirVideo2.asp">进入教室上课</a></div>
						  ...
						  <iframe src="guide_EnvirVideo2_.asp" width="545" height="410" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" ></iframe>
						  <!--<embed id="ShowVideo" src="/video/envTest/step2.wmv" width="400" height="300" type="application/x-mplayer2" wmode="transparent" showstatusbar="0" autostart="true" EnableContextMenu="false" ></embed>-->
